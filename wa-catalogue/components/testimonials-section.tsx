...
const testimonials = [
  ...
  {
    name: "Eric Hounkpe",
    business: "Électricien Pro Cotonou",
    image: "👨🏿",
    rating: 5,
    text: "Avant je perdais du temps dans les groupes. Maintenant, les clients m'écrivent directement pour des dépannages. Je trouve des missions chaque semaine.",
  },
  {
    name: "Fatou Sow",
    business: "Nettoyage Pro & Pressing à Domicile",
    image: "👩🏿",
    rating: 5,
    text: "Je reçois des demandes qualifiées pour le ménage et le pressing à domicile. Le bot pose les bonnes questions et je gagne du temps.",
  },
  {
    name: "Ibrahim Traoré",
    business: "Déménagement Express Porto-Novo",
    image: "👨🏾",
    rating: 5,
    text: "Grâce à Wa-Catalog, on nous trouve vite pour les déménagements de dernière minute. Les demandes arrivent 24/7, c'est top.",
  },
]
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-[family-name:var(--font-poppins)] mb-4 text-balance">
            Ce Que Disent Nos <span className="text-primary">Vendeurs et Prestataires</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Rejoignez des centaines de vendeurs et prestataires satisfaits qui transforment leur activité
          </p>
  </div>
