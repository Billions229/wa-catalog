...
const features = [
  {
    ...
    description: "Les clients trouvent vos produits et services instantanément via WhatsApp grâce à notre IA.",
  },
  {
    icon: Zap,
  ...
  {
    icon: TrendingUp,
    title: "Ventes & Missions en hausse",
    description: "Atteignez des clients qui cherchent activement vos produits ou un prestataire proche d'eux.",
  },
  {
    icon: Users,
    title: "Base Clientèle & Demandes",
    description: "Connectez-vous à une communauté grandissante d'acheteurs et demandeurs en Afrique de l'Ouest.",
  },
  {
    icon: Globe,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            La solution pour transformer WhatsApp en votre meilleur vendeur et assistant de mise en relation
          </p>
        </motion.div>
